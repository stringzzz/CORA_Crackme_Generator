...
To note, I will often just be showing detailed end-of-line comments for the first time some code appears in one of the crackme executables. In later levels when that same code appears, I will most likely just put pre and post comments on there to give a brief summary of what it is doing. If needed, you may need to view the disassembly analysis of earlier levels to see the full details.
